      ...
      <main className="flex-1 flex flex-col w-full max-w-4xl mx-auto px-4 sm:px-8 py-8 gap-8 pb-24 md:pb-8">
        <div className="header text-left">
          <h1 className="text-3xl font-bold text-[#1a1c18] flex items-center gap-3">
            <i className="fa-solid fa-gear text-[#1a1c18]/80 drop-shadow-md"></i>
            Settings
          </h1>
          <p className="text-[#1a1c18]/60 mt-1 font-medium">Manage your account preferences and app behavior.</p>
        </div>

        <div className="bg-white p-8 rounded-3xl border border-[#1a1c18]/10 shadow-sm flex flex-col gap-8">
          ...
          <section className="flex flex-col gap-4 border-b border-[#1a1c18]/10 pb-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 ml-0 md:ml-10">
              <div>
                <p className="font-semibold text-[#1a1c18]">App Language</p>
                <p className="text-sm text-gray-500">Select the primary language for the application interface.</p>
              </div>
              <select 
                className="w-full md:w-48 p-3 rounded-xl border border-gray-200 bg-gray-50 text-sm font-semibold text-[#1a1c18] cursor-pointer outline-none focus:border-[#1a1c18] transition-colors"
                value={language}
          ...
          <section className="flex flex-col gap-4 border-b border-[#1a1c18]/10 pb-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 ml-0 md:ml-10">
              <div>
                <p className="font-semibold text-[#1a1c18]">Dark Mode</p>
          ...
          <section className="flex flex-col gap-4 border-b border-[#1a1c18]/10 pb-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 ml-0 md:ml-10 mb-2 md:mb-4">
              <div>
                <p className="font-semibold text-[#1a1c18]">Email Summaries</p>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 ml-0 md:ml-10">
              <div>
                <p className="font-semibold text-[#1a1c18]">Push Notifications</p>
      ...
      {showLogoutModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#1a1c18]/60 backdrop-blur-sm transition-opacity">
          <div className="bg-white rounded-3xl w-full max-w-sm overflow-hidden flex flex-col shadow-2xl animate-in fade-in zoom-in-95 duration-200 p-6 text-center">
            ...
            <h2 className="text-xl font-bold text-[#1a1c18] mb-2">Ready to leave?</h2>
            ...
            <div className="flex gap-3 w-full">
              <button 
                ...
                className="flex-1 py-3 px-4 rounded-xl font-bold text-[#1a1c18]/70 hover:bg-gray-100 transition-colors cursor-pointer"
              >
                Cancel
              </button>
              <button 
